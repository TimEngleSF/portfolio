    ...
    <div className="fixed left-0 top-[35%] hidden flex-col lg:flex ">
      <ul>
        <li className="ml-[-100px] flex h-14 w-40 items-center justify-between rounded-tr-md bg-termScreen  px-4 duration-300 hover:ml-[-10px] hover:rounded-md">
          <a
            href="https://www.linkedin.com/in/tim-engle"
            target="_blank"
        ...
        <li className="undefined ml-[-100px] flex h-14 w-40 items-center justify-between bg-termScreen px-4 duration-300 hover:ml-[-10px] hover:rounded-md">
          <a
            href="https://github.com/TimEngleSF"
            target="_blank"
            className="flex w-full items-center justify-between text-termTop"
            rel="noreferrer"
          >
        ...
        <li className="undefined ml-[-100px] flex h-14 w-40 items-center justify-between bg-termScreen px-4 duration-300 hover:ml-[-10px] hover:rounded-md">
          <a
            href="mailto:timothy.englew@gmail.com"
            target="_blank"
            className="flex w-full items-center justify-between text-termTop"
            rel="noreferrer"
          >
